...
export default function HomePage() {
  return (
    ...
    sm:gap-4 md:gap-5 justify-center pb-20">
        ...
        <h3 className='font-medium md:text-lg'>Record <span className='text-blue-400'>&rarr;</span> Transcribe 
        ...
        <p className='text-base'>Or <label className='text-blue-400 cursor-pointer hover:text-blue-600 duration-200'>Upload <input className='hidden' type='file' accept='.mp3, .wave'></input>
        </label>a mp3 file</p>
